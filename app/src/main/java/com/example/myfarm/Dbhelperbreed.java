...
public class Dbhelperbreed extends SQLiteOpenHelper{
    public long result;
        ...
        // Database Name
        private static final String DATABASE_NAME = "InfoManager.db";

        // User table name
        private static final String TABLE_USER = "breed";
         ...
         * @param context
         */
        public Dbhelperbreed(Context context) {
