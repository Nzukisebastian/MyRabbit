...
public class Dbbreeding extends SQLiteOpenHelper {
    public long result;
    ...
    // Database Name
    private static final String DATABASE_NAME = "BreedingManager.db";

    // User table name
    private static final String TABLE_USER = "breeding";
     ...
     * @param context
     */
    public Dbbreeding(Context context) {
